...
class RequestOpenedWebhookFactoryTest extends \PHPUnit_Framework_TestCase
{
    public function testParseData()
    {
        ...
        $webhook = RequestOpenedWebhookFactory::parseData($data);

        // Tests we get the right Webhook
        $this->assertInstanceOf(RequestOpenedWebhook::class, $webhook);
